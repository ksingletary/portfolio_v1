            ...
            <div className="px-4 md:px-20">
                <div className="flex flex-col lg:flex-row justify-center">
                    ...
                    <div className="to-animate from-left flex flex-col w-full max-w-xl">
                        ...
                        <Link href="/contact" className="h-11 w-48 ml-0 md:ml-10 px-8 py-2 bg-primary hover:bg-secondary transform ease-in-out duration-300 hover:-translate-y-1 font-semibold text-center text-white text-xl rounded-full shadow-xl dark:shadow-gray-900">
                            Let&apos;s do this!
                        </Link>
                    </div>
