                ...
                <div className="flex flex-col lg:flex-row justify-center">
                    <Tilt>
                        <div className="to-animate scale-up flex flex-row lg:hidden mb-16 justify-center">
                            <img src="/manStanding.png" alt="Man standing with swirling galaxy illustration behind him" className="w-4/5" />
                        </div>
                    </Tilt>

                    <Tilt>
                        <div className="to-animate scale-up hidden lg:flex justify-center">
                            <img src="/manStanding.png" alt="Man standing with swirling galaxy illustration behind him" className="w-5/6" />
                        </div>
                    </Tilt>
